...
public class DeleteZone extends ImageView implements DropTarget, DragController.DragListener {
    ...
    private boolean mTransitionBackground = false;
    ...
    public DeleteZone(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTransitionBackground = a.getBoolean(R.styleable.DeleteZone_transition_background, mTransitionBackground);
        a.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        if(mTransitionBackground){
        	
        	Drawable db = getBackground();
            if(db != null && (db instanceof TransitionDrawable)){
            	mTransition = (TransitionDrawable)db;
            }
            else
    ...
    public boolean onDrop(DragObject dragObject) {
        ...
        if (item.container == -1) return false;
        ...
        if (item instanceof UserFolderInfo) {
            ...
            LauncherModel.deleteUserFolderContentsFromDatabase(mLauncher, userFolderInfo, isAppMode);
        ...
        LauncherModel.deleteItemFromDatabase(mLauncher, item, isAppMode);
