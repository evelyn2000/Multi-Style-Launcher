...
public class CellLayout extends ViewGroup {
    ...
    protected RectF mDragRect = new RectF();
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        //mIsBottomBar = a.getBoolean(R.styleable.CellLayout_isBottomBar, false);

        a.recycle();

        setAlwaysDrawnWithCacheEnabled(false);
        
        mPortrait = context.getResources().getDisplayMetrics().heightPixels > context.getResources().getDisplayMetrics().widthPixels;// heightSpecSize > widthSpecSize;
        ...
        //QsLog.LogW("CellLayout::CellLayout()===mPortrait:"+mPortrait+"==mShortAxisCells:"+mShortAxisCells+"==mLongAxisCells:"+mLongAxisCells);
    }
...
//QsLog.LogD("CellLayout::onInterceptTouchEvent()==action:"+(ev.getAction() & MotionEvent.ACTION_MASK)+"=isClickable:"+isClickable()+"==isEnabled:"+isEnabled()+"=isLongClickable:"+isLongClickable());
                ...
                if ((child.getVisibility()) == VISIBLE || child.getAnimation() != null) {
                    ...
                    if (frame.contains(x, y)) {
                        ...
                        if (tag != null && (tag instanceof ShortcutInfo)){
                        	if((((ShortcutInfo)tag).qsExtParam & LauncherSettings.Favorites.QS_EXT_PARAM_LOCKED) > 0){
                        		isLockItem = true;
                        		break;
                        	}
                        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mPortrait) {
            ...
            //QsLog.LogW("CellLayout::onMeasure(Portrait)==vSpaceLeft:"+vSpaceLeft+"==hSpaceLeft:"+hSpaceLeft
            //		+"==mWidthGap:"+mWidthGap+"==mHeightGap:"+mHeightGap
            //		+"==numLongGaps:"+numLongGaps+"==numShortGaps:"+numShortGaps);
        } else {
            ...
            //QsLog.LogW("CellLayout::onMeasure(land)==vSpaceLeft:"+vSpaceLeft+"==hSpaceLeft:"+hSpaceLeft
            //		+"==mWidthGap:"+mWidthGap+"==mHeightGap:"+mHeightGap
            //		+"==numLongGaps:"+numLongGaps+"==numShortGaps:"+numShortGaps);
        }
...
//        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public void setup(int cellWidth, int cellHeight, int widthGap, int heightGap,
            ...
            if (widthGap < 0) {
                width = myCellHSpan * cellWidth + (myCellHSpan * widthGap) -
            ...
            if (heightGap < 0) {
                height = myCellVSpan * cellHeight + (myCellVSpan * heightGap) -
    ...
    public static final class CellInfo implements ContextMenu.ContextMenuInfo {
    	...
    	public boolean findCellForSpan(int[] cellXY, int spanX, int spanY, boolean clear) {
            final ArrayList<VacantCell> list = vacantCells;
            final int count = list.size();
    ...
    public void dumpCellInfo(){
    	for(int cellY = 0; cellY < mLongAxisCells; cellY++){
        	for(int cellX = 0; cellX < mShortAxisCells; cellX++){
            	QsLog.LogD("dumpCellInfo()====cellY:"+cellY+"==cellX:"+cellX+"==flag:"+mOccupied[cellX][cellY]);
            }
        }
    }
    public void reSortCellsForApps(){
        ...
        int cellX = vacant[0];
        int cellY = vacant[1];
        int nStartIndex = cellX  + cellY * mShortAxisCells;
        int nCount = super.getChildCount();
        //QsLog.LogD("reSortCellsForApps()====cellY:"+cellY+"==cellX:"+cellX+"==nStartIndex:"+nStartIndex+"=nCount:"+nCount);
        while(nStartIndex < nCount){
        	final View child = getChildAt(nStartIndex);
            LayoutParams lp = (LayoutParams) child.getLayoutParams();
            lp.cellX = cellX;
            lp.cellY = cellY;
            ...
            info.cellX = cellX;
            info.cellY = cellY;
            LauncherModel.updateItemInDatabase(getContext(), info, true);
            cellX++;
            if(cellX >= mShortAxisCells){
            	cellY++;
            	if(cellY >= mLongAxisCells)
            		break;
            	cellX = 0;
            }
            nStartIndex++;
