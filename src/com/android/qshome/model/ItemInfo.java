...
public class ItemInfo {
    ...
    // jz
    //public boolean isAppMode = false;
    public int qsExtParam = 0;
    ...
    public void onAddToDatabase(ContentValues values) { 
        ...
        //values.put(LauncherSettings.BaseLauncherColumns.APPS_WIDGET_MODE, isAppMode);
        if (!isGesture) {
            ...
            values.put(LauncherSettings.Favorites.QS_EXT_PARAM, qsExtParam);
        }
    }
    ...
    public String toString() {
        return "Item(id=" + this.id + " type=" + this.itemType + " container="+container+" qsExtParam="+qsExtParam+")";
    }
}
